...
exports.run = async (client, message, args) => {
  ...
  .setTitle(`<a:cristal:714275787712233502> ${client.user.username} - Ping <a:cristal:714275787712233502>`)
  .setDescription(`<a:cristal:714275787712233502> **|** Minha latência é de \`${client.ws.ping}ms.\`\n<a:cristal:714275787712233502> **|** Servidor Shard N°${message.guild.shardID}`)
